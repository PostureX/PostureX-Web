...
export default function ProfileModal({ open, onOpenChange }: ProfileModalProps) {
    ...
    return (
        ...
        <AlertDialogContent id="profile" aria-describedby="profile-dialog-description">
                <AlertDialogDescription id="profile-dialog-description" className="hidden">
                    This dialog shows your profile information and allows you to generate a Telegram link for notifications.
                </AlertDialogDescription>
                <AlertDialogHeader>
